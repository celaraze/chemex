...
Thank you for considering contributing to Tinker! The contribution guide can be found in
...
Please review [our security policy](https://github.com/laravel/tinker/security/policy) on how to report security
vulnerabilities.

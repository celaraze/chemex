...
<?php foreach ($frames as $i => $frame): ?>
    <div
        ...
        <div class="frame-method-info">
            <span
                class="frame-class"><?php echo $tpl->breakOnDelimiter('\\', $tpl->escape($frame->getClass() ?: '')) ?></span>
            <span
                class="frame-function"><?php echo $tpl->breakOnDelimiter('\\', $tpl->escape($frame->getFunction() ?: '')) ?></span>
        </div>

<div class="input-group input-group-sm">
    @if($group)
        <div class="input-group-prepend dropdown">
            ...
            <input type="hidden" name="{{ $id }}_group" class="{{ $group_name }}-operation"
                   value="{{ request($id.'_group', 0) }}"/>
    ...
    <input class="form-control" id="{{$id}}" autocomplete="off" placeholder="{{$label}}" name="{{$name}}"
